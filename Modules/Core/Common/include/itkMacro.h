...
#define itkGetInputMacro(name, type) ITK_DETAIL_GetInputMacroImpl(virtual, , name, type)
/** @ITKEndGrouping */
...
#define itkGetDecoratedInputMacro(name, type) ITK_DETAIL_GetDecoratedInputMacroImpl(virtual, , name, type)
/** @ITKEndGrouping */
...
#define itkFinalSetDecoratedObjectInputMacro(name, type) \
  ITK_DETAIL_SetDecoratedObjectInputMacroImpl(, final, name, type)
#define itkNonVirtualSetDecoratedObjectInputMacro(name, type) \
  ITK_DETAIL_SetDecoratedObjectInputMacroImpl(, , name, type)
...
#define itkFinalGetDecoratedObjectInputMacro(name, type) \
  ITK_DETAIL_GetDecoratedObjectInputMacroImpl(, final, name, type)
#define itkNonVirtualGetDecoratedObjectInputMacro(name, type) \
  ITK_DETAIL_GetDecoratedObjectInputMacroImpl(, , name, type)
#define itkGetDecoratedObjectInputMacro(name, type) ITK_DETAIL_GetDecoratedObjectInputMacroImpl(virtual, , name, type)
/** @ITKEndGrouping */

/** Combined Set/Get for a decorated itk::Object-derived input. */
/** @ITKStartGrouping */
...
// Do not invoke ITK_DETAIL_GetMacroImpl directly from user code; use the public wrappers below.
#define ITK_DETAIL_GetMacroImpl(virtualKeyword, finalKeyword, name, type) \
  virtualKeyword type Get##name() finalKeyword { return this->m_##name; } \
  ITK_MACROEND_NOOP_STATEMENT

// Do not invoke ITK_DETAIL_GetConstMacroImpl directly from user code; use the public wrappers below.
#define ITK_DETAIL_GetConstMacroImpl(virtualKeyword, finalKeyword, name, type)  \
  virtualKeyword type Get##name() const finalKeyword { return this->m_##name; } \
  ITK_MACROEND_NOOP_STATEMENT

// Do not invoke ITK_DETAIL_GetConstReferenceMacroImpl directly from user code; use the public wrappers below.
#define ITK_DETAIL_GetConstReferenceMacroImpl(virtualKeyword, finalKeyword, name, type) \
...
#define itkGetMacro(name, type) ITK_DETAIL_GetMacroImpl(virtual, , name, type)
/** @ITKEndGrouping */
...
#define itkGetConstMacro(name, type) ITK_DETAIL_GetConstMacroImpl(virtual, , name, type)
/** @ITKEndGrouping */
...
#define itkGetStringMacro(name) ITK_DETAIL_GetStringMacroImpl(virtual, , name)
/** @ITKEndGrouping */
...
// Do not invoke ITK_DETAIL_GetModifiableObjectMacroImpl directly from user code; use the public wrappers below.
#  define ITK_DETAIL_GetModifiableObjectMacroImpl(virtualKeyword, finalKeyword, name, type)          \
...
#define itkGetObjectMacro(name, type) ITK_DETAIL_GetObjectMacroImpl(virtual, , name, type)

#define itkVirtualGetModifiableObjectMacro(name, type) ITK_DETAIL_GetModifiableObjectMacroImpl(virtual, , name, type)
#define itkFinalGetModifiableObjectMacro(name, type) ITK_DETAIL_GetModifiableObjectMacroImpl(, final, name, type)
#define itkNonVirtualGetModifiableObjectMacro(name, type) ITK_DETAIL_GetModifiableObjectMacroImpl(, , name, type)
#define itkGetModifiableObjectMacro(name, type) ITK_DETAIL_GetModifiableObjectMacroImpl(virtual, , name, type)
/** @ITKEndGrouping */
...
#define itkFinalGetConstReferenceObjectMacro(name, type) \
  ITK_DETAIL_GetConstReferenceObjectMacroImpl(, final, name, type)
#define itkNonVirtualGetConstReferenceObjectMacro(name, type) \
  ITK_DETAIL_GetConstReferenceObjectMacroImpl(, , name, type)
...
#define itkBooleanMacro(name) ITK_DETAIL_BooleanMacroImpl(virtual, , name)
/** @ITKEndGrouping */
...
#define itkGetVectorMacro(name, type, count) ITK_DETAIL_GetVectorMacroImpl(virtual, , name, type, count)
/** @ITKEndGrouping */
...
#define itkGetDecoratedOutputMacro(name, type) ITK_DETAIL_GetDecoratedOutputMacroImpl(virtual, , name, type)
/** @ITKEndGrouping */
