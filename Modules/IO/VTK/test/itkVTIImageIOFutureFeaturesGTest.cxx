...
TEST(VTIImageIOFutureFeatures, F001_LZ4)
{
  CheckGuard("VTI_guard_lz4.vti", "F-001 LZ4");
}

// F-002: vtkLZMADataCompressor should raise a tagged exception.
TEST(VTIImageIOFutureFeatures, F002_LZMA)
{
  CheckGuard("VTI_guard_lzma.vti", "F-002 LZMA");
}
...
TEST(VTIImageIOFutureFeatures, F005_MultiPiece)
{
  CheckGuard("VTI_guard_multipiece.vti", "F-005 Multi-Piece");
}
