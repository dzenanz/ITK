...
void
BSplineCenteredL2ResampleImageFilterBase<TInputImage, TOutputImage>::PrintSelf(std::ostream & os, Indent indent) const
{
...
template <typename TInputImage, typename TOutputImage>
void
BSplineCenteredL2ResampleImageFilterBase<TInputImage, TOutputImage>::InitializePyramidSplineFilter(int SplineOrder)
{
  switch (SplineOrder)
  {
    case 1:
    ...
    default:
      ...
      err.SetDescription("SplineOrder for Centered L2 pyramid filter must be 1 through 4. Requested spline order has "
